# UNZER PAYMENT MODULE FOR OXID ESHOP 6

Use Unzer Payment plugin for OXID 6 to provide an easy-to-install payment gateway integration for all your online payments.
...
##### 1. Run the below command to install the payment module
 ```
 composer require unzerdev/oxid-6
 ```
